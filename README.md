...
<p align="center">
  <a href="#"><img src="https://img.shields.io/badge/R-%3E%3D%204.0-blue" alt="R >= 4.0"></a>
  <a href="#"><img src="https://img.shields.io/badge/CLSI-EP05%20%7C%20EP06%20%7C%20EP09%20%7C%20EP12%20%7C%20EP15%20%7C%20EP17%20%7C%20EP25%20%7C%20EP28-blueviolet" alt="CLSI standards"></a>
...
```r
obj <- precision(data, form = y ~ day/run/rep, by = "sample")
...
<p align="center">
  <sub>Built for IVD reagent verification — designed for reproducibility and clarity.</sub>
  <br>
  <sub>为 IVD 试剂验证而生 — 追求可复现与清晰。</sub>
</p>
